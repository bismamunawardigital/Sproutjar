# Sproutjar — Loom demo script

Six to seven minutes. Structure is context → struggle → transformation, opened *in medias res*
(the product first, the setup after), and closed by telling them what they just saw.

Before recording: full-screen Chrome, one tab, notifications off, seeded demo profile (Layla, AED),
mic tested. Have `/dashboard` already open so the first frame is the product, not a loading page.
...
> maths problem, it's a shame problem, and nobody talks to a spreadsheet at 1am."

## 2 · Struggle (40s) — name the loop

**On screen:** point at "Rent on the debt — AED 1,328, the interest, every month".

> "Here's the loop. AED 1,328 a month is rent she pays on money she already spent. There's no
> buffer, so the next surprise goes on a card. And every app she's tried made her feel worse:
> red numbers, broken streaks, budgets she failed by day nine."
...
Say out loud, before you speak to Ren:
> "Ren already knows her numbers. Watch — I never tell it anything."

Then the live exchange (~60s). Aim for these three beats:
1. Ren opens by asking how she's doing, not by pitching. Answer honestly, briefly.
2. Ren cites the real figures — three cards, AED 39,100, the ADCB Traveller as the smallest.
3. **Deliberately go quiet for ten seconds.** Say afterwards: "That silence is the feature. It
   waits. It doesn't fill the gap, because thinking is the work."

End the call. The close card appears with the sprout.
...
## 7 · Close (20s) — tell them what you told them

> "Debt advice isn't scarce. Someone to talk to at 1am, who knows your numbers and doesn't make
> you feel worse for asking, is. That's Sproutjar."

---

## The one thing to protect

If time is short, cut sections 5 and 6 — never section 3. The demo is the conversation; everything
else is evidence that the conversation is real.

## Backup plan if the call fails live

Pre-record a 60-second clip of one Ren call and keep it ready to cut in. Voice over live networks
in a recording is the only genuinely fragile part of this.
